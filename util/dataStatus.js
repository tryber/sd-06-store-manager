const Messages = {
    invalidName : {err: { code: 'invalid_data',message: '"name" length must be at least 5 characters long' }},

    productExist: {err: { code: 'invalid_data', message: 'Product already exists' }},

    largerZero: {err: { code: 'invalid_data',message: '"quantity" must be larger than or equal to 1' }},
    ...
    InvalidQuantity: {err: { code: 'invalid_data', message: 'Wrong product ID or invalid quantity'}},
